...
using tp03_asp.net.Models;
using tp03_asp.net1.Data;

namespace tp03_asp.net1.Controllers
{
    public class Logins1Controller : ApiController
    {
        private tp03_aspnet1dbContext db = new tp03_aspnet1dbContext();

        [EnableCors(origins: "http://localhost:61337", headers: "*", methods: "*")]
        // GET: api/Logins1
